...
public:
  Loop028() : Demoloop(CYCLE_LENGTH, 150, 150, 150), RADIUS(10), maxD(width / 4) {
  ...
  void Update() {
    ...
    outsideTransform.get() = glm::rotate(outsideTransform.get(), -cycle_ratio * (float)DEMOLOOP_M_PI * 2, {0, 0, 1});
